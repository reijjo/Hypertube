...
const BestRating = () => {
    ...
    const loadMoreMovies = async () => {
        ...
        const moviesToFetch = newMovies.filter(
            (movie) => !posterUrls[movie.imdb_code]
        );
    ...
    const filterMovies = (movie) => {
        ...
        const searchFilter =
            ...
            movie.title
                .toLowerCase()
                .includes(DOMPurify.sanitize(query).toLowerCase()) ||
            movie.year
                .toString()
                .includes(DOMPurify.sanitize(query).toLowerCase()) ||
    ...
    const filteredMovies =
        query.trim() === '' ? movies : movies.filter(filterMovies);
    ...
    useEffect(() => {
        ...
        const moviesToFetch = filteredMovies.filter(
            (movie) => !posterUrls[movie.imdb_code]
        );
                        ...
                        <main>
                            <div className="mb-10">
                                <div className="flex justify-between px-4 pt-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
                                    ...
                                    <Menu
                                        as="div"
                                        className="relative inline-block mt-2 ml-auto text-left"
                                    >
                                        <div>
                                            <Menu.Button
